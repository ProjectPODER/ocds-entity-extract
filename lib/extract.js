    ...
    if(govLevel != null) {
        ...
        switch(govLevel) {
            case 'city':
                ...
                if(!stateIndex) {
                    // Crear el estado
                    state = createState(stateID, party.address.region, countryID, metadata);
                ...
                if(!municipalityIndex) {
                    // Crear la municipalidad
                    municipality = createState(municipalityID, party.address.locality, stateID, metadata);
...
function createState(id, name, parent_id = null, metadata) {
    let state = {
        id: id,
        name: name,
