                ...
                contract.items.map( item => {
                    ...
                    if(prodID /*&& cbmeiProd*/) {
                        ...
                        if(item.hasOwnProperty('unit') &&  && item.unit.hasOwnProperty('value')) {
                            ...
                            let purchasePrice = item.unit.value * item.quantity;
...
function createState(type, id, name, parent = null, metadata) {
    ...
    if(otherNames)
        Object.assign(state, { other_names: otherNames });
    ...
    if(govLevel != null) {
        ...
        switch(govLevel) {
            ...
            case 'region':
                ...
                if(otherNames)
                    Object.assign(stateObj, { other_names: otherNames });
                area.push(stateObj);
            case 'country':
                let countryObj = {
...
function getOtherStateNames(state) {
    let otherNames = null;
    switch(state) {
        case 'Coahuila': otherNames = ['Coahuila de Zaragoza'];
        case 'Estado de México': otherNames = ['México'];
        case 'Michoacán': otherNames = ['Michoacán de Ocampo'];
        case 'Veracruz': otherNames = ['Veracruz de Ignacio de la Llave'];
    }
    return otherNames;
}
